            ...
            <div className="landing-cta-section mx-auto">
                <div className="landing-content">
                    ...
                    <p className="personal-summary">
                        ...
                        about cutting edge technology. When I'm not building user-oriented
                        software solutions you can find me at the park with my beautiful
                        family, in my home studio producing instrumentals, or at the gym
                        practicing jiu jitsu!
                    </p>

                    <p className="work-line">
                        I am currently happily employed in the beautiful city of Colorado
                        Springs.
                    </p>
                </div>
